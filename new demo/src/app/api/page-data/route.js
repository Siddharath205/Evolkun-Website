...
const creativeMindList = [
  {
    image: "/images/home/creative/4.png",
    name: "Ajay Thapa",
    position: "Senior Advisor",
    company: " Guiding with wisdom",
  ...
  {
    image: "/images/home/creative/5.png",
    name: "Neelam Thapa",
    position: "Stakeholder",
    company: "Backing innovation and growth",
    // bio: "Diseñadora de los iconos originales de Macintosh. Revolucionó la interfaz gráfica de usuario y estableció estándares visuales que perduran hasta hoy.",
    // linkedinLink: "https://www.linkedin.com/in/susan-kare-a950/",
    // portfolioUrl: "https://kare.com/",
    // twitterLink: "https://kare.com/",
  ...
  {
    image: "/images/home/creative/2.png",
    name: "Kunal Thapa",
    position: "CEO & Founder",
    company: "Leads vision and strategy",
  ...
  {
    image: "/images/home/creative/3.png",
    name: "Jai Singh Tomar",
    position: "Marketing Head",
    company: "Driving digital growth",
  ...
  {
    image: "/images/home/creative/1.png",
    name: "Shubham Semwal",
    position: "Lead Developer",
    company: "Building tech with precision",
   ...
   {
    image: "/images/home/creative/6.png",
    name: "Vidhi Thakuri",
    position: "3D Designer",
    company: " Crafting visuals in 3D",
    // bio: 'Autor de "The Design of Everyday Things". Acuñó el término "User Experience" y estableció los principios fundamentales del diseño centrado en el usuario.',
    // linkedinLink: "https://www.linkedin.com/in/don-norman-1a001/",
    // portfolioUrl: "https://jnd.org/",
    // twitterLink: "https://jnd.org/",
...
const faqList = [
  {
    ...
    faq_ans:
      "UX (User Experience) se enfoca en la experiencia completa del usuario, incluyendo investigación, arquitectura de información y flujos. UI (User Interface) se centra en el diseño visual de la interfaz: colores, tipografías, botones y elementos gráficos. Ambas disciplinas trabajan juntas para crear productos digitales efectivos.",
  },
  {
    faq_que: "¿Qué herramientas son esenciales para empezar en UX/UI?",
    faq_ans:
      "Para comenzar necesitas: Figma o Sketch para diseño de interfaces, Miro o Mural para mapas mentales y flujos, Maze o UsabilityHub para testing, y herramientas de prototipado como InVision o Principle. Muchas de estas tienen versiones gratuitas perfectas para estudiantes.",
  },
  {
    faq_que: "¿Cómo se aplica Design Thinking en proyectos reales?",
    faq_ans:
      "Design Thinking sigue 5 fases: Empatizar (investigar usuarios), Definir (identificar problemas), Idear (generar soluciones), Prototipar (crear versiones de prueba) e Iterar (mejorar basado en feedback). Se aplica desde apps móviles hasta servicios físicos, siempre poniendo al usuario en el centro.",
  },
  {
    faq_que: "¿Qué es la investigación de usuarios y por qué es importante?",
    faq_ans:
      "La investigación de usuarios incluye entrevistas, encuestas, análisis de comportamiento y testing de usabilidad para entender necesidades, motivaciones y frustraciones. Es fundamental porque evita suposiciones incorrectas y asegura que el diseño resuelva problemas reales de usuarios reales.",
  },
  {
    faq_que: "¿Cómo se hace un prototipo efectivo?",
    faq_ans:
      "Un prototipo efectivo debe tener el nivel de fidelidad apropiado para el objetivo: wireframes para estructura, mockups para diseño visual, y prototipos interactivos para flujos. Debe ser rápido de crear, fácil de modificar y permitir testing temprano con usuarios reales.",
  },
  {
...
const achievementsList = [
  {
    ...
    title:
      "Douglas Engelbart presenta el primer mouse y la interfaz gráfica, cambiando para siempre la interacción humano-computadora.",
    year: "1968",
  ...
  },
  {
    ...
    title:
      "Xerox Alto introduce la primera interfaz gráfica comercial con ventanas, iconos y menús.",
    year: "1973",
  ...
  },
  {
    ...
    title:
      'Don Norman publica "The Design of Everyday Things", estableciendo los principios fundamentales del UX.',
    year: "1988",
    url: "https://jnd.org/",
  },
  {
    ...
    title:
      "Tim Berners-Lee crea la World Wide Web, democratizando el acceso a la información global.",
    year: "1990",
  ...
  },
  {
    ...
    title:
      "Apple iPhone redefine la interacción móvil con gestos táctiles intuitivos y diseño minimalista.",
    year: "2007",
  ...
  },
  {
    ...
    title:
      "Ethan Marcotte introduce el concepto de Responsive Web Design, adaptando interfaces a cualquier pantalla.",
    year: "2010",
