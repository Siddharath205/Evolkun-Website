...
export default function AppDevMainForm() {
  ...
  const appDevQuestions = [
    ...
    },
    {
      ...
      options: [
        { label: "My customers or clients", value: "clients", score: 22 },
        { label: "Other businesses", value: "b2b", score: 26},
        { label: "My team / internal use", value: "internal", score: 24 },
        { label: "Anyone — open to the public", value: "public", score: 23 },
      ],
    },
    {
      id: 5,
    ...
    },
    {
      ...
      options: [
        { label: "Android phones", value: "android", score: 30 },
        { label: "iPhones (iOS)", value: "ios", score: 30 },
        { label: "Both Android and iOS", value: "both", score: 35 },
        { label: "Just a web app", value: "web", score: 28 },
      ],
    },
    {
      id: 8,
    ...
    },
    {
      ...
      options: [
        ...
        { label: "Not sure yet", value: "unsure", score: 13 },
      ],
    },
    {
      id: 11,
